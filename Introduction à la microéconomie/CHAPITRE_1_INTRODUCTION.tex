...
% il faut excecuterr en luatex pour les émoji : config > compilateur
\author{Issa KACHAOU}
...
\section{Qu'est ce que l'économie ?\emoji{bar-chart}}
	\begin{frame}{Qu'est ce que l'économie ?\emoji{bar-chart}}
